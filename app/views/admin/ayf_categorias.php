...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Categorías</h2>
    <div>
        <button class="btn btn-primary btn-modal-create" data-modal="#modalCategoria" data-title="Nueva Categoría"><i class="bi bi-plus-lg"></i> Nueva</button>
    </div>
</div>
<div class="card">
    <div class="card-body">
        <div class="mb-3">
            <input type="text" class="form-control table-search" placeholder="Buscar categoría...">
        </div>
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?=$f['id']?></td>
                        <td><span style="display:inline-block;width:24px;height:24px;border-radius:50%;background:<?=htmlspecialchars($f['color']??'#e63946')?>"></span></td>
                        ...
                        <td>
                            <button class="btn btn-sm btn-warning btn-modal-edit" data-modal="#modalCategoria" data-id="<?=$f['id']?>" data-url="ayf-admin/categorias/data/"><i class="bi bi-pencil"></i></button>
                            <button class="btn btn-sm btn-danger delete-item" data-id="<?=$f['id']?>" data-url="ayf-admin/categorias/eliminar/"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
...
<div class="modal fade" id="modalCategoria" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="modal-form" method="POST" enctype="multipart/form-data" action="<?=BASE_URL?>ayf-admin/categorias/guardar">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-2"><label class="form-label">Color</label><input type="color" name="color" class="form-control form-control-color" value="#e63946"></div>
...
<?php $content = ob_get_clean(); $title = 'Categorías'; require __DIR__.'/ayf_layout.php'; ?>
